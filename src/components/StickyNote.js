...
export default function StickyNote(props) {
  ...
  useEffect(() => {
    if (notesData) {
      // console.warn(notesData.images.length);
      ...
      notesData.charts.length > 0 &&
        !availableData.includes('chart-bar') &&
        setAvailableData(availableData.concat('chart-bar'));
      notesData.tables?.replace(/[\[\]""]/g, '') !== '' &&
        !availableData.includes('file-table') &&
        setAvailableData(availableData.concat('file-table'));
    }
  }, [notesData, props.data]);
        ...
        <View style={styles.menuBackground}>
          <View
            ...
            <Menu.Item
              ...
              title="View"
              titleStyle={{fontFamily: fonts.regular, color: colors.text}}
            />
            <Menu.Item
              icon="pencil-outline"
              onPress={() => {
          ...
          <View style={styles.hiddenContainer}>
            ...
            <View style={styles.buttonsContainer}>
              <TouchableOpacity
                ...
                <Image
                  source={DELETE}
                  style={[styles.swipeIcon, {tintColor: colors.text}]}
                />
              </TouchableOpacity>
              <TouchableOpacity
              ...
              <ImageBackground
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <FlatList
                    ...
                    extraData={[props.data, availableData]}
                  />
                </View>
                <Text
                  numberOfLines={
                ...
                <Text
                  ...
                  {formatDate(dateAdded, null, 'MMMM D, YYYY hh:mm A')}
                </Text>
              </ImageBackground>
            </TouchableHighlight>
          </View>
